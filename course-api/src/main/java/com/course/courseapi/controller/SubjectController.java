...
public class SubjectController {
	...
	@DeleteMapping("/subject/remove-subject-from-course/{courseId}")
	public JsonResponse removeSubjFromCourse(@PathVariable("courseId") int courseId, @RequestBody int  subjectId) {
		return JsonResponse.setJsonResponse("", "", "", subjectDetailService.removeSubjectFromCourse(courseId, subjectId), true);
